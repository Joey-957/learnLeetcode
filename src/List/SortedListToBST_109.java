...
public class SortedListToBST_109 {
    ...
    private void listToMap(ListNode head) {
        int i = 0;
        while (head != null) {
    ...
    public TreeNode_ sortedListToBST(ListNode head) {
        listToMap(head);
        return helper(0, max);
    }
    ...
    public TreeNode_ sortedListToBST2(ListNode head) {
        if (head == null) {
            return null;
        }
